    ...
    return (
      <section className="relative isolate overflow-hidden bg-white px-6 py-6 sm:py-8 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl lg:max-w-4xl">
          {/* <img className="mx-auto h-12" src="https://tailwindui.com/img/logos/workcation-logo-indigo-600.svg" alt="SolarShop" /> */}
          <h2 className="mx-auto" style={{width: 200, fontWeight:700, fontSize: 30}}>SolarShop</h2>
        ...
        Discover efficient and eco-friendly solutions with our range of solar panels – powering tomorrow, today.”
            ...
            <figcaption className="mt-10">
              ...
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                ...
                <div className="text-gray-600">CEO of solarshop</div>
              </div>
            </figcaption>
          </figure>
        </div>
